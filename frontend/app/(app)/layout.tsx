...
/**
 * Shared shell for every signed-in page: top bar, sidebar (md and up) and main content, inside
 * the announcer that shows toasts and speaks results to screen readers.
 */
